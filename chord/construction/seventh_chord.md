...
Stack one more third on top of a [[triad]] and you get a **seventh chord** — four notes instead of three (degrees 1, 3, 5, 7). That fourth note opens up a much richer palette of qualities than the plain major/minor/diminished/augmented set:

- **maj7** — major triad + a major 7th. Lush, "jazzy" consonance.
- **dom7** — major triad + a minor 7th. The workhorse of the blues — wants to resolve.
- **min7** — minor triad + a minor 7th. Mellow.
